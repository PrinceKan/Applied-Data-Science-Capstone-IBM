...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        # Use the entire dataframe to calculate total successes
        ...
        # Create a pie chart for success vs. failed launches for the selected site
...
def update_scatter_chart(selected_site, selected_payload):
    ...
    if selected_site == 'ALL':
        ...
        # Scatter plot for the selected site with selected payload range
        fig = px.scatter(filtered_df,
                         x='Payload Mass (kg)',
                         y='class',
                         color='Booster Version Category',
